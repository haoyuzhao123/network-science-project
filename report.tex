\documentclass{article}
    ...
    In this project, we study a problem that is related to both online decision problem, or more specificly, the multi-armed bandit, and the information synchronization problem.
